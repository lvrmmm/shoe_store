...
import misis.ignatova_maria.shoe_store.util.ImageValidator;
...
public class ImageService {
    ...
    public ImageIcon validateAndScale(ImageIcon imageIcon) {
        return ImageValidator.validateAndScale(imageIcon);
    }
}