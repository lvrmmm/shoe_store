...
public class ImageLoader {
    ...
    // Кэш для изображений
    private static java.util.Map<String, ImageIcon> cache = new java.util.HashMap<>();
    ...
    public static ImageIcon loadLogo() {
        ...
        for (String path : paths) {
            ...
            if (url != null) return scaleIcon(url, 120, 60);
        }
        return null;
    }
    ...
    public static ImageIcon loadIcon() {
        ...
        if (url != null) return scaleIcon(url, 32, 32);
    ...
    private static ImageIcon loadPlaceholder(int width, int height) {
        ...
        if (url != null) return scaleIcon(url, width, height);
        return new ImageIcon();
    }
    ...
    private static ImageIcon scaleIcon(ImageIcon original, int maxWidth, int maxHeight) {
        ...
        if (originalWidth <= maxWidth && originalHeight <= maxHeight) return original;
