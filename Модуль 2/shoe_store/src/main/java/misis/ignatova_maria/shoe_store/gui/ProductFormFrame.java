...
public class ProductFormFrame extends JFrame {
    ...
    private void loadData() {
        if (isEditMode && editingProduct != null) {
            ...
            discountSpinner.setValue(editingProduct.getDiscount() != null ? editingProduct.getDiscount().intValue() : 0);
    ...
    private void saveProduct() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Неверный формат цены. Используйте числа с точкой (например: 4990.00)",
                    "Ошибка ввода",
                    JOptionPane.ERROR_MESSAGE,
                    null
            );
            ...
            JOptionPane.showMessageDialog(this,
                    "Ошибка при сохранении товара: " + e.getMessage(),
                    "Ошибка",
                    JOptionPane.ERROR_MESSAGE,
                    null
            );
    ...
    private boolean validateForm() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Введите корректную цену (например: 4990.00)",
                    "Ошибка валидации",
                    JOptionPane.ERROR_MESSAGE,
                    null
            );
    ...
    private static class EntityListCellRenderer<T> extends DefaultListCellRenderer {
        @Override
